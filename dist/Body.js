...
var Body = (function (_CosmeticPart) {
  _inherits(Body, _CosmeticPart);

  function Body(lights, spoiler, color, controls, cost, size, maker) {
    _classCallCheck(this, Body);

    _get(Object.getPrototypeOf(Body.prototype), 'constructor', this).call(this, color, 'metal', controls, cost, size, maker);
    this._doorsNumber = 4;
